...
## 3.3 plot graph 1 : Global active power vs datewithTime

plot(dateWithTime,data$Global_active_power,type = "ln",ylab = "Global Active Power(killowatts)",
     xlab = "")

## 3.4 plot graph 2 : sub_Meetering (1,2,3) Vs weekdays
...
legend("topright",col = colors,legend = legendnames,lty = c(1,1,1),cex = 0.5)

## 3.5 plot graph 3: Voltage Vs date time 

plot(dateWithTime,data$Voltage,type = "ln",ylab = "Voltage",xlab = "datetime")

## 3.6 plot graph 4: Global_reactive_power vs datetime

plot(dateWithTime,data$Global_reactive_power,type = "ln",ylab = "Global_reactive_powe",xlab = "datetime")
